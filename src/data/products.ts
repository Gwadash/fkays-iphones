...
export const brandNewProducts: Product[] = [
  ...
  { id: "6", model: "iPhone X", storage: "64GB", price: 4800, condition: "brand-new", image: "/lovable-uploads/14b8ff94-84eb-4d5f-8808-deba2dd270ea.png", discount: 600 },
  { id: "7", model: "iPhone XS", storage: "64GB", price: 5100, condition: "brand-new", image: "/lovable-uploads/f9f08086-3414-4ee4-9f09-246de5adee3f.png", discount: 700 },
  { id: "8", model: "iPhone XR", storage: "64GB", price: 4900, condition: "brand-new", image: "/lovable-uploads/c16f4f49-c799-4c19-acdb-5e25d8f042f8.png", discount: 500 },
  { id: "9", model: "iPhone XR", storage: "128GB", price: 5300, condition: "brand-new", image: "/lovable-uploads/c16f4f49-c799-4c19-acdb-5e25d8f042f8.png", discount: 600 },
  ...
  { id: "11", model: "iPhone 11", storage: "128GB", price: 6500, condition: "brand-new", image: "/lovable-uploads/7c5544b8-af91-4224-9d62-46067b2c070f.png", discount: 800 },
  ...
  { id: "18", model: "iPhone 13 Pro", storage: "128GB", price: 14500, condition: "brand-new", image: "/lovable-uploads/c3a1f61e-6476-46ff-b5b7-f0dc3cb55c1e.png", discount: 1000 },
  { id: "19", model: "iPhone 14", storage: "128GB", price: 12800, condition: "brand-new", image: "/lovable-uploads/15778401-8141-4ff2-a54a-6b6073be207b.png", discount: 900 },
...
export const preOwnedProducts: Product[] = [
  ...
  { id: "30", model: "iPhone XR", storage: "64GB", price: 4300, condition: "pre-owned", image: "/lovable-uploads/c16f4f49-c799-4c19-acdb-5e25d8f042f8.png", discount: 500 },
  { id: "31", model: "iPhone XR", storage: "128GB", price: 4900, condition: "pre-owned", image: "/lovable-uploads/c16f4f49-c799-4c19-acdb-5e25d8f042f8.png", discount: 600 },
  { id: "32", model: "iPhone X", storage: "64GB", price: 4100, condition: "pre-owned", image: "/lovable-uploads/14b8ff94-84eb-4d5f-8808-deba2dd270ea.png", discount: 500 },
